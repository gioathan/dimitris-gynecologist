          ...
          <div className="space-y-8">
            {contactItems.map(({ key, icon, label, value }) => (
              <div key={key} className="flex items-center gap-5">
                <div className="w-14 h-14 rounded-full bg-surface-container-lowest flex items-center justify-center text-on-secondary-container shadow-sm shrink-0">
                  {key === "instagram" ? (
                    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-on-secondary-container" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <p className="text-xs uppercase tracking-widest text-on-secondary-container font-bold mb-1">{label}</p>
